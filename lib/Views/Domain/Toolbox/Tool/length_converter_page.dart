          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _buildShortcutBtn('4×8 板 長邊', 'm', 2.424),
                _buildShortcutBtn('1英吋 = ?mm', 'mm', 25.4),
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_currentUnit != 'cm') _buildResultRow('公分 (cm)', 'cm'),
                  if (_currentUnit != 'mm') _buildResultRow('公釐 (mm)', 'mm'),
                  if (_currentUnit != 'm') _buildResultRow('公尺 (m)', 'm'),
                  if (_currentUnit != 't-chi') _buildResultRow('台尺', 't-chi'),
                  if (_currentUnit != 't-tsun') _buildResultRow('台寸', 't-tsun'),
                  if (_currentUnit != 't-fen') _buildResultRow('台分', 't-fen'),
                  if (_currentUnit != 'in') _buildResultRow('英吋 (in)', 'in'),
                  if (_currentUnit != 'ft') _buildResultRow('英呎 (ft)', 'ft'),
                  if (_currentUnit != 'yd') _buildResultRow('碼 (yd)', 'yd', isLast: true),
                ],
              ),
            ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isSelected ? Border.all(color: const Color(0xFFE5BA73), width: 1.5) : Border.all(color: Colors.transparent, width: 1.5),
          ),
