    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // 工具列表
          const _ToolTile(icon: Icons.calculate_outlined, title: '工時計算', subtitle: '快速估算班別與加班'),
          const _ToolTile(icon: Icons.photo_camera_outlined, title: '照片紀錄', subtitle: '現場照片分類上傳'),
          const _ToolTile(icon: Icons.inventory_2_outlined, title: '材料清單', subtitle: '常用材料與數量'),
          const _ToolTile(icon: Icons.near_me_outlined, title: '快速派工', subtitle: '依空班人員派發任務'),
